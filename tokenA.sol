...
contract tokenA{
    ...
    string public constant name = "A";  // name of token
    string public constant symbol = "A"; // symbol of token
    ...
    using SafeMathTokenA for uint256; // use matha
    ...
    // For increase total supply of token A
    function newTokenA(uint256 numberOfTokens) public contractOwner 
    {
    ...
    // For decrease total supply of token A
    function decreaseTokenA(uint256 numberOfTokens) public contractOwner 
    {
